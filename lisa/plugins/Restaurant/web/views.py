...
from lisa.plugins.Restaurant.modules.restaurant import Restaurant

# Template system will be fixed with Django 1.7. Each plugin will be able to have his own templates
@login_required()
def index(request):

    return render_to_response(os.path.abspath(os.path.dirname(__file__) + '/templates/restaurant-index.html'),
                              {
                                  'content': 'test'
                              },
